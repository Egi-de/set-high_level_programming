#!/usr/bin/python3
"""Module that defines a Rectangle able to build squares."""


class Rectangle:
    """Represents a rectangle, including the special case of a square."""
    ...
    def bigger_or_equal(rect_1, rect_2):
        """Return whichever rectangle has the bigger (or equal) area."""
